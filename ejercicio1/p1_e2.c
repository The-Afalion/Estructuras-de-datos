...
int main() {
    ...
    printf(
        "Inserting Paint It, Black... result...: %d",
        (int)radio_newMusic(r,
                            "id:\"111\" title:\"Paint It, Black\" artist:\"The "
                            "Rolling Stones\" duration:\"202\""));
    printf("\n");

    printf("Inserting Every Breath You Take... result...: %d",
           (int)radio_newMusic(r,
                               "id:\"222\" title:\"Every Breath You Take\" "
    ...
    printf("Number of Connections from %d: %d\n", ID_dest,
           radio_getNumberOfRelationsFromId(r, ID_dest));
    printf("Number of Connections from %d: %d\n\n", ID_orig,
           num_relations_dest);
    ...
    for (int i = 0; i < num_relations_dest; i++) printf("%ld ", reco_music[i]);
    printf("\n\n");
